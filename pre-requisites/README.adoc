...
Setup the `Spring-Workshop-Dish` repository link:https://github.com/phopper-pivotal/Spring-Workshop-Dish[Spring Workshop]

* fork the labs repository to your account. 
* if proxy does not allow you to fork or clone the repo directly you can download the ZIP file

== Target

. If you haven't already, download the latest release of the Cloud Foundry CLI from https://github.com/cloudfoundry/cli/releases for your operating system and install it.
. Download Diego plugin and install as per direction from https://docs.pivotal.io/pivotalcf/1-7/adminguide/apps-enable-diego.html#install-cli

. Set the API target for the CLI: (set appropriate end point for your environment)
+
----
$ cf api https://api.sys.internal-green.dev.mer.cfdish.io --skip-ssl-validation
----

. Login to Pivotal Cloudfoundry (please specify organization: *_DEVELOPMENT-GREEN_* and space respective of your organization, default to *_Sandbox_*):
+
----
$ cf login
----
...
. when pushing an application, the details below can be used as an example
+
----
$ cf push
----
...
====
----
Using manifest file /Users/phopper/workspace/cf-spring-mvc-boot/manifest.yml <1>
...
Uploading app files from: /Users/phopper/workspace/cf-spring-mvc-boot/target/cf-spring-mvc-boot-0.0.1-SNAPSHOT.jar
...
Here the CLI is creating a route with random word tokens inserted (again, see `manifest.yml` for a hint!) to prevent route collisions across the default `api.sys.internal-green.dev.mer.cfdish.io` domain.
...
Here the droplet is being uploaded to Pivotal Cloudfoundry's internal blobstore so that it can be easily copied to one or more _https://docs.pivotal.io/pivotalcf/1-7/concepts/diego/diego-architecture.html[Diego Architecture]_ for execution.
